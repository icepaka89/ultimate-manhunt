...
public class DebuffAssassinCommandExecutor implements CommandExecutor {
    ...
    public DebuffAssassinCommandExecutor(UltimateManHunt plugin, UmhManager manager) {
        this.plugin = plugin;
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String label, String[] args) {
        try {
            // Make sure debuff value was specified
            if(args.length == 0) {
                return false;
            }

            manager.setAssassinDeBuff(
